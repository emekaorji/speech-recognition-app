...
const useSpeechRecognition = (
	...
	const initializeSpeechRecognition = useCallback(() => {
		...
		recognition.current.onaudiostart = (e) =>
			callback(e, _options.onaudiostart);
		...
		recognition.current.onsoundstart = (e) =>
			callback(e, _options.onsoundstart);
	...
	return useMemo<SpeechRecognitionObject>(
		() => ({
			...
			abort: recognition.current.abort,
